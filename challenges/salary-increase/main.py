...
def calculate_discount(current_salary):
...
def calculate_salary_increase(percentage_increase):
...
percentage_increase = calculate_discount(current_salary)
new_salary, increase_amount = calculate_salary_increase(percentage_increase)
